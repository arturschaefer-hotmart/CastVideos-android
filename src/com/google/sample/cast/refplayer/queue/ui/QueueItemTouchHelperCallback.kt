...
import com.google.sample.cast.refplayer.queue.ui.QueueListAdapter.ItemTouchHelperViewHolder
 ...
 */
class QueueItemTouchHelperCallback(private val mAdapter: ItemTouchHelperAdapter) : ItemTouchHelper.Callback() {
    ...
    override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder,
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (viewHolder is QueueItemViewHolder) {
