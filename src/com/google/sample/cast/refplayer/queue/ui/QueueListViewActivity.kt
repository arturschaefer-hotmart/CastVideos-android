...
class QueueListViewActivity : AppCompatActivity() {
    private val mRemoteMediaClientCallback: RemoteMediaClient.Callback = MyRemoteMediaClientCallback()
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_settings -> startActivity(Intent(this@QueueListViewActivity, CastPreference::class.java))
            R.id.action_clear_queue -> getInstance(applicationContext)!!.removeAll()
